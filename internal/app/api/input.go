...
type EventCommand struct {
	ForTeam  *state.Team      `json:"forTeam" yaml:"forTeam"`
	Type     state.RefCommand `json:"commandType" yaml:"type"`
	Location *state.Location  `json:"location" yaml:"location"`
}
...
type EventModifyGameEventBehavior struct {
	GameEventType     state.GameEventType     `json:"gameEventType" yaml:"gameEventType"`
	GameEventBehavior state.GameEventBehavior `json:"gameEventBehavior" yaml:"gameEventBehavior"`
}

// EventModifyValue is an event that can be applied
type EventModifyValue struct {
	ForTeam state.Team `json:"forTeam,omitempty"`
