...
type ProposedGameEvent struct {
	...
	ValidUntil *uint64 `protobuf:"varint,1,req,name=valid_until,json=validUntil" json:"valid_until,omitempty"` // Deprecated: Do not use.
...
var fileDescriptor_92a5ea5b58ff1871 = []byte{
	...
	,
}
