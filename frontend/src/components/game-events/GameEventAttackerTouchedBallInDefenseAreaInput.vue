...
import {GameEvent_AttackerTouchedBallInDefenseArea, GameEvent_Type} from "@/proto/ssl_gc_game_event";
...
const details = ref<GameEvent_AttackerTouchedBallInDefenseArea>(gameEvent.value.event.attackerTouchedOpponentInDefenseArea)
