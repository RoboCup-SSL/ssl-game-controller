...
var file_ssl_gc_rcon_team_proto_rawDesc = []byte{
	...
	0x52, 0x04, 0x74, 0x65, 0x61, 0x6d, 0x22, 0xb1, 0x01, 0x0a, 0x10, 0x54, 0x65, 0x61, 0x6d, 0x54,
...
var file_ssl_gc_rcon_team_proto_depIdxs = []int32{
	...
	4, // 1: TeamRegistration.team:type_name -> Team
	3, // 2: TeamToController.signature:type_name -> Signature
	5, // 3: ControllerToTeam.controller_reply:type_name -> ControllerReply
