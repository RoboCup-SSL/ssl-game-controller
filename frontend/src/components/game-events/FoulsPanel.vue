...
import {ref} from "vue";
import {GameEvent_Type, gameEvent_TypeFromJSON} from "@/proto/ssl_gc_game_event";
...
const fouls = Object.keys(components).map(k => gameEvent_TypeFromJSON(k))
