...
type Referee struct {
	...
	// The time in microseconds that is remaining until a lack of progress will be called, if the ball has not moved
	// The time will not be reset, if the ball has moved. It can get negative.
	// An autoRef would raise an appropriate event, if the time gets negative and the ball has not moved.
	LackOfProgressTimeRemaining *int32   `protobuf:"varint,15,opt,name=lack_of_progress_time_remaining,json=lackOfProgressTimeRemaining" json:"lack_of_progress_time_remaining,omitempty"`
...
func (m *Referee) GetLackOfProgressTimeRemaining() int32 {
	if m != nil && m.LackOfProgressTimeRemaining != nil {
		return *m.LackOfProgressTimeRemaining
	}
	return 0
}
...
var fileDescriptor_f003bb08adc02ebb = []byte{
	...
	,
}
