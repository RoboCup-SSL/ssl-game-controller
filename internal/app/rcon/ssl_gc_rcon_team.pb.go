...
var file_ssl_gc_rcon_team_proto_goTypes = []any{
...
func file_ssl_gc_rcon_team_proto_init() {
	...
	file_ssl_gc_rcon_team_proto_msgTypes[1].OneofWrappers = []any{
	...
	file_ssl_gc_rcon_team_proto_msgTypes[2].OneofWrappers = []any{
