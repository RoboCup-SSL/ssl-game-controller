...
func (x *TrackerWrapperPacket) Reset() {
	*x = TrackerWrapperPacket{}
	mi := &file_tracker_ssl_vision_wrapper_tracked_proto_msgTypes[0]
...
func (*TrackerWrapperPacket) Descriptor() ([]byte, []int) {
	return file_tracker_ssl_vision_wrapper_tracked_proto_rawDescGZIP(), []int{0}
}
...
var File_tracker_ssl_vision_wrapper_tracked_proto protoreflect.FileDescriptor

var file_tracker_ssl_vision_wrapper_tracked_proto_rawDesc = []byte{
	0x0a, 0x28, 0x74, 0x72, 0x61, 0x63, 0x6b, 0x65, 0x72, 0x2f, 0x73, 0x73, 0x6c, 0x5f, 0x76, 0x69,
	...
	0x6b, 0x65, 0x72, 0x2f, 0x73, 0x73, 0x6c, 0x5f, 0x76, 0x69, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x64,
	...
	0x65, 0x64, 0x46, 0x72, 0x61, 0x6d, 0x65, 0x42, 0x61, 0x42, 0x1c, 0x53, 0x73, 0x6c, 0x56, 0x69,
	0x73, 0x69, 0x6f, 0x6e, 0x57, 0x72, 0x61, 0x70, 0x70, 0x65, 0x72, 0x54, 0x72, 0x61, 0x63, 0x6b,
	0x65, 0x64, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x3f, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var (
	file_tracker_ssl_vision_wrapper_tracked_proto_rawDescOnce sync.Once
	file_tracker_ssl_vision_wrapper_tracked_proto_rawDescData = file_tracker_ssl_vision_wrapper_tracked_proto_rawDesc
)

func file_tracker_ssl_vision_wrapper_tracked_proto_rawDescGZIP() []byte {
	file_tracker_ssl_vision_wrapper_tracked_proto_rawDescOnce.Do(func() {
		file_tracker_ssl_vision_wrapper_tracked_proto_rawDescData = protoimpl.X.CompressGZIP(file_tracker_ssl_vision_wrapper_tracked_proto_rawDescData)
	})
	return file_tracker_ssl_vision_wrapper_tracked_proto_rawDescData
}

var file_tracker_ssl_vision_wrapper_tracked_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_tracker_ssl_vision_wrapper_tracked_proto_goTypes = []any{
	(*TrackerWrapperPacket)(nil), // 0: TrackerWrapperPacket
	(*TrackedFrame)(nil),         // 1: TrackedFrame
}
var file_tracker_ssl_vision_wrapper_tracked_proto_depIdxs = []int32{
...
func init() { file_tracker_ssl_vision_wrapper_tracked_proto_init() }
func file_tracker_ssl_vision_wrapper_tracked_proto_init() {
	if File_tracker_ssl_vision_wrapper_tracked_proto != nil {
		return
	}
	file_tracker_ssl_vision_detection_tracked_proto_init()
	type x struct{}
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			GoPackagePath: reflect.TypeOf(x{}).PkgPath(),
			RawDescriptor: file_tracker_ssl_vision_wrapper_tracked_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   1,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_tracker_ssl_vision_wrapper_tracked_proto_goTypes,
		DependencyIndexes: file_tracker_ssl_vision_wrapper_tracked_proto_depIdxs,
		MessageInfos:      file_tracker_ssl_vision_wrapper_tracked_proto_msgTypes,
	}.Build()
	File_tracker_ssl_vision_wrapper_tracked_proto = out.File
	file_tracker_ssl_vision_wrapper_tracked_proto_rawDesc = nil
	file_tracker_ssl_vision_wrapper_tracked_proto_goTypes = nil
	file_tracker_ssl_vision_wrapper_tracked_proto_depIdxs = nil
}
