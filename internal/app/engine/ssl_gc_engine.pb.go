...
type TeamAdvantageResponse_AdvantageResponse int32

const (
	// stop the game
	TeamAdvantageResponse_STOP TeamAdvantageResponse_AdvantageResponse = 0
	// keep the match running
	TeamAdvantageResponse_CONTINUE TeamAdvantageResponse_AdvantageResponse = 1
)

// Enum value maps for TeamAdvantageResponse_AdvantageResponse.
var (
	TeamAdvantageResponse_AdvantageResponse_name = map[int32]string{
		0: "STOP",
		1: "CONTINUE",
	}
	TeamAdvantageResponse_AdvantageResponse_value = map[string]int32{
		"STOP":     0,
		"CONTINUE": 1,
	}
)

func (x TeamAdvantageResponse_AdvantageResponse) Enum() *TeamAdvantageResponse_AdvantageResponse {
	p := new(TeamAdvantageResponse_AdvantageResponse)
	*p = x
	return p
}

func (x TeamAdvantageResponse_AdvantageResponse) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (TeamAdvantageResponse_AdvantageResponse) Descriptor() protoreflect.EnumDescriptor {
	return file_ssl_gc_engine_proto_enumTypes[0].Descriptor()
}

func (TeamAdvantageResponse_AdvantageResponse) Type() protoreflect.EnumType {
	return &file_ssl_gc_engine_proto_enumTypes[0]
}

func (x TeamAdvantageResponse_AdvantageResponse) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Do not use.
func (x *TeamAdvantageResponse_AdvantageResponse) UnmarshalJSON(b []byte) error {
	num, err := protoimpl.X.UnmarshalJSONEnum(x.Descriptor(), b)
	if err != nil {
		return err
	}
	*x = TeamAdvantageResponse_AdvantageResponse(num)
	return nil
}

// Deprecated: Use TeamAdvantageResponse_AdvantageResponse.Descriptor instead.
func (TeamAdvantageResponse_AdvantageResponse) EnumDescriptor() ([]byte, []int) {
...
type GcStateTeam struct {
	...
	LastAdvantageResponse *TeamAdvantageResponse `protobuf:"bytes,5,opt,name=last_advantage_response,json=lastAdvantageResponse" json:"last_advantage_response,omitempty"`
}
...
func (x *GcStateTeam) GetLastAdvantageResponse() *TeamAdvantageResponse {
	if x != nil {
		return x.LastAdvantageResponse
	}
	return nil
}

// The response from a team regarding the advantage rule
type TeamAdvantageResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	// the response of the team
	Response *TeamAdvantageResponse_AdvantageResponse `protobuf:"varint,1,opt,name=response,enum=TeamAdvantageResponse_AdvantageResponse" json:"response,omitempty"`
	// the timestamp of the response
	Timestamp *timestamppb.Timestamp `protobuf:"bytes,2,opt,name=timestamp" json:"timestamp,omitempty"`
}

func (x *TeamAdvantageResponse) Reset() {
	*x = TeamAdvantageResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *TeamAdvantageResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*TeamAdvantageResponse) ProtoMessage() {}

func (x *TeamAdvantageResponse) ProtoReflect() protoreflect.Message {
	mi := &file_ssl_gc_engine_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TeamAdvantageResponse.ProtoReflect.Descriptor instead.
func (*TeamAdvantageResponse) Descriptor() ([]byte, []int) {
	return file_ssl_gc_engine_proto_rawDescGZIP(), []int{2}
}

func (x *TeamAdvantageResponse) GetResponse() TeamAdvantageResponse_AdvantageResponse {
	if x != nil && x.Response != nil {
		return *x.Response
	}
	return TeamAdvantageResponse_STOP
}

func (x *TeamAdvantageResponse) GetTimestamp() *timestamppb.Timestamp {
	if x != nil {
		return x.Timestamp
	}
	return nil
...
var file_ssl_gc_engine_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x22, 0x9b, 0x04, 0x0a, 0x07, 0x47, 0x63, 0x53, 0x74, 0x61, 0x74, 0x65, 0x12, 0x36,
	...
	0x74, 0x65, 0x47, 0x63, 0x12, 0x2a, 0x0a, 0x11, 0x72, 0x65, 0x61, 0x64, 0x79, 0x5f, 0x74, 0x6f,
	0x5f, 0x63, 0x6f, 0x6e, 0x74, 0x69, 0x6e, 0x75, 0x65, 0x18, 0x05, 0x20, 0x01, 0x28, 0x08, 0x52,
	0x0f, 0x72, 0x65, 0x61, 0x64, 0x79, 0x54, 0x6f, 0x43, 0x6f, 0x6e, 0x74, 0x69, 0x6e, 0x75, 0x65,
	...
	0x22, 0xb3, 0x02, 0x0a, 0x0b, 0x47, 0x63, 0x53, 0x74, 0x61, 0x74, 0x65, 0x54, 0x65, 0x61, 0x6d,
	...
	,
	...
	0x22, 0x2b, 0x0a, 0x11, 0x41, 0x64, 0x76, 0x61, 0x6e, 0x74, 0x61, 0x67, 0x65, 0x52, 0x65, 0x73,
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x08, 0x0a, 0x04, 0x53, 0x54, 0x4f, 0x50, 0x10, 0x00, 0x12,
	0x0c, 0x0a, 0x08, 0x43, 0x4f, 0x4e, 0x54, 0x49, 0x4e, 0x55, 0x45, 0x10, 0x01, 0x22, 0x41, 0x0a,
	...
	0x22, 0x80, 0x01, 0x0a, 0x0e, 0x47, 0x63, 0x53, 0x74, 0x61, 0x74, 0x65, 0x54, 0x72, 0x61, 0x63,
	0x6b, 0x65, 0x72, 0x12, 0x1f, 0x0a, 0x0b, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x6e, 0x61,
	...
	,
	...
	0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x61, 0x70, 0x70, 0x2f, 0x65, 0x6e,
	0x67, 0x69, 0x6e, 0x65,
}
...
var file_ssl_gc_engine_proto_goTypes = []interface{}{
	(TeamAdvantageResponse_AdvantageResponse)(0), // 0: TeamAdvantageResponse.AdvantageResponse
	(*GcState)(nil),               // 1: GcState
	(*GcStateTeam)(nil),           // 2: GcStateTeam
	(*TeamAdvantageResponse)(nil), // 3: TeamAdvantageResponse
	...
	(*geom.Vector3)(nil),          // 12: Vector3
	(*state.RobotId)(nil),         // 13: RobotId
	(*geom.Vector2)(nil),          // 14: Vector2
}
var file_ssl_gc_engine_proto_depIdxs = []int32{
	...
	3,  // 4: GcStateTeam.last_advantage_response:type_name -> TeamAdvantageResponse
	0,  // 5: TeamAdvantageResponse.response:type_name -> TeamAdvantageResponse.AdvantageResponse
	11, // 6: TeamAdvantageResponse.timestamp:type_name -> google.protobuf.Timestamp
	6,  // 7: GcStateTracker.ball:type_name -> Ball
	7,  // 8: GcStateTracker.robots:type_name -> Robot
	12, // 9: Ball.pos:type_name -> Vector3
	12, // 10: Ball.vel:type_name -> Vector3
	13, // 11: Robot.id:type_name -> RobotId
	14, // 12: Robot.pos:type_name -> Vector2
	2,  // 13: GcState.TeamStateEntry.value:type_name -> GcStateTeam
	4,  // 14: GcState.AutoRefStateEntry.value:type_name -> GcStateAutoRef
	5,  // 15: GcState.TrackerStateEntry.value:type_name -> GcStateTracker
...
func file_ssl_gc_engine_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_ssl_gc_engine_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*TeamAdvantageResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
